...
This directory contains scripts for evaluating the `mig-prompt-builder` skill.
...
Run your evals in a workspace directory (e.g., `mig-prompt-builder-workspace/iteration-1/`):
...
git commit -m "Add benchmark results for mig-prompt-builder iteration 1"
git push
```
