...
This directory contains scripts for evaluating the `mig-test-gen` skill.
...
Run your evals in a workspace directory (e.g., `mig-test-gen-workspace/iteration-1/`):
...
```bash
cd mig-test-gen/evals
python grade_outputs.py ../../mig-test-gen-workspace/iteration-1 eval-1-vague-java
```
...
```bash
cd mig-test-gen/evals
python aggregate_benchmark.py ../../mig-test-gen-workspace/iteration-1 1 ../../benchmark-results
```
...
git commit -m "Add benchmark results for mig-test-gen iteration 1"
git push
```
