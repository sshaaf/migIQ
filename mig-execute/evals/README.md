...
This directory contains scripts for evaluating the `mig-execute` skill.
...
Run your evals in a workspace directory (e.g., `mig-execute-workspace/iteration-1/`):
...
```bash
cd mig-execute/evals
python grade_outputs.py ../../mig-execute-workspace/iteration-1 eval-1-vague-java
```
...
```bash
cd mig-execute/evals
python aggregate_benchmark.py ../../mig-execute-workspace/iteration-1 1 ../../benchmark-results
```
...
git commit -m "Add benchmark results for mig-execute iteration 1"
git push
```
