...
This directory contains scripts for evaluating the `mig-graphify` skill.
...
Run your evals in a workspace directory (e.g., `mig-graphify-workspace/iteration-1/`):
...
```bash
cd mig-graphify/evals
python grade_outputs.py ../../mig-graphify-workspace/iteration-1 eval-1-vague-java
```
...
```bash
cd mig-graphify/evals
python aggregate_benchmark.py ../../mig-graphify-workspace/iteration-1 1 ../../benchmark-results
```
...
git commit -m "Add benchmark results for mig-graphify iteration 1"
git push
```
